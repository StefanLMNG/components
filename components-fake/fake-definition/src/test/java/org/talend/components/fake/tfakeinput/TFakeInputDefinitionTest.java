...
public class TFakeInputDefinitionTest {
	...
	/**
	 * Check {@link TFakeInputDefinition#getFamilies()} returns string
	 * array, which contains "Processing"
	 */
	@Test
	...
	/**
	 * Check {@link TFakeInputDefinition#getName()} returns
	 * "tFilterColumn"
	 */
	@Test
	...
	/**
	 * Check {@link TFakeInputDefinition#getPropertyClass()} returns
	 * class, which canonical name is
	...
	/**
	 * Check {@link TFakeInputDefinition#getRuntimeInfo()} returns instance
	 * of "org.talend.components.processing.runtime.tfiltercolumn.tFilterColumnRuntime"
	 */
	@Test
	...
	/**
	 * Check {@link TFakeInputDefinition#isSchemaAutoPropagate()}
