...
public class TFakeLogDefinitionTest {
	...
	/**
	 * Check {@link TFakeLogDefinition#getFamilies()} returns string
	...
	/**
	 * Check {@link TFakeLogDefinition#getName()} returns
	 * "tFilterColumn"
	 */
	@Test
	...
	/**
	 * Check {@link TFakeLogDefinition#getPropertyClass()} returns
	...
	/**
	 * Check {@link TFakeLogDefinition#getRuntimeInfo()} returns instance
