...
public class DatastoreServiceSpring implements DatastoreService {
    ...
    public Schema getSchema(ComponentProperties componentProperties, Connector connector, boolean isOuput) {
        return datastoreServiceDelegate.getSchema(componentProperties, connector, isOuput);
    }
    ...
    public Set<? extends Connector> getAvailableConnectors(ComponentProperties componentProperties,
        ...
        return datastoreServiceDelegate.getAvailableConnectors(componentProperties, connectedConnetor, isOuput);
    }

    @Override
    public void setSchema(ComponentProperties componentProperties, Connector connector, Schema schema, boolean isOuput) {
        datastoreServiceDelegate.setSchema(componentProperties, connector, schema, isOuput);
    }
