...
public class UserPasswordMongoDBProperties extends PropertiesImpl {

    public Property<AuthenticationType> authenticationType = newEnum("AuthenticationType", AuthenticationType.class).setRequired();
    ...
    public UserPasswordMongoDBProperties(String name) {
        super(name);
    }
